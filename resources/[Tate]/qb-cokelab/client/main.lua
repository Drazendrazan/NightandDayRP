...
Citizen.CreateThread(function()
    Wait(500)
    Framework.Functions.TriggerCallback('qb-cokelab:server:GetData', function(data)
                                ...
                                if(Vdist(pos, Config.Ingredients["lab"].coords.x, Config.Ingredients["lab"].coords.y, Config.Ingredients["lab"].coords.z, true) < 1)then
                                    if CarryPackage == nil then
                                        ...
                                        if IsControlJustPressed(0, Keys["E"]) then
                                            ...
                                            Framework.Functions.Progressbar("pickup_reycle_package", "Grabbing ingredients..", 5000, false, true, {}, {}, {}, {}, function() -- Done
                                ...
                                if not Config.Tasks[CurrentTask].started then
                                    if not Config.Tasks[CurrentTask].done then
                                        ...
                                        if IsControlJustPressed(0, Keys["E"]) then
                                            ...
                                            TaskStartScenarioInPlace(PlayerPedId(), "PROP_HUMAN_BUM_BIN", 0, true)
                                            Framework.Functions.Progressbar("fullcut_cycle_v6_cokecutter", "Processing..", 12000, false, true, {}, {}, {}, {}, function() -- Done
                                                ClearPedTasks(PlayerPedId())
                                            end)
                                        end
...
function FinishMachine(k)
    ...
    Framework.Functions.Notify('Step Complete.', 'success')
