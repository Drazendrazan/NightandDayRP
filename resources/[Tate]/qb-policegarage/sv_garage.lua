...
AddEventHandler('qb-policegarage:server:AddGarage', function(vehmodel, hash)
    ...
    if Player ~= nil then
        ...
        Framework.Functions.ExecuteSql(false, "INSERT INTO `player_vehicles` (`steam`, `citizenid`, `vehicle`, `hash`, `mods`, `plate`, `state`) VALUES ('"..Player.PlayerData.steam.."', '"..Player.PlayerData.citizenid.."', '"..vehmodel.."', '"..hash.."', '{}', '"..newplate.."', 0)")
