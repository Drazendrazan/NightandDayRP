...
$(document).on('click', '.appartment-dots', function(e){
    ...
    CloseContainer()
    $.post('http://qb-spawn/ChooseAppartment', JSON.stringify({
        AppId: AppartmentDot
    }))
});
...
$(document).on('click', '.jail-dots', function(e){
    ...
    $.post('http://qb-spawn/SpawnJail', JSON.stringify({
        JailId: JailDot
    }))
});

CloseContainer = function() {
 $.post('http://qb-spawn/Close', JSON.stringify({})) 
...
OnClick = function() {
  $.post('http://qb-spawn/Click', JSON.stringify({}))  
}
