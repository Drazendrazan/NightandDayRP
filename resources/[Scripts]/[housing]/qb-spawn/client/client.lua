...
RegisterNetEvent('qb-spawn:client:choose:spawn')
AddEventHandler('qb-spawn:client:choose:spawn', function()
...
RegisterNetEvent('qb-spawn:client:choose:appartment')
AddEventHandler('qb-spawn:client:choose:appartment', function()
    SetEntityVisible(PlayerPedId(), false)
    DoScreenFadeOut(250)
    Citizen.Wait(2000)
    DoScreenFadeIn(250)
...
RegisterNUICallback('ChooseAppartment', function(data)
    ...
    SetSkyCam(false)
    TriggerEvent('Framework:Client:OnPlayerLoaded')
    TriggerServerEvent('qb-appartments:server:set:appartment:data', data.AppId)
end)
...
RegisterNUICallback('SpawnJail', function(data)
    ...
    TriggerEvent('Framework:Client:OnPlayerLoaded')
    Citizen.Wait(100)
    TriggerEvent('qb-prison:client:spawn:prison')
end)
