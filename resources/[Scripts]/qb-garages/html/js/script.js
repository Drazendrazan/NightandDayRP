...
SetupGarageVehicles = function(data) {
  ...
  for (const [key, value] of Object.entries(data.garagevehicles)) {
    if (value['State'] === 'out') {
      var AddVehicle = '<div class="vecicle-container" data-plate='+value['Plate']+' data-model='+value['Model']+' data-state='+value['State']+' data-fuel='+value['Fuel']+' data-motor='+value['Motor']+' data-body='+value['Body']+'><span class="vehicle-status status-out">Out</span><p><i class="fas fa-car"></i> '+ value['Name'] +'</p></div>'
