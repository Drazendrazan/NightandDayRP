...
FrameworkAdmin = {}
FrameworkAdmin.Functions = {}
in_noclip_mode = false

FrameworkAdmin.Functions.DrawText3D = function(x, y, z, text, lines)
    if lines == nil then
        lines = 1
    end
...
Citizen.CreateThread(function()
    ...
    WarMenu.CreateMenu('admin', 'Framework Admin')
    ...
    while true do
        ...
        if showNames then
            for _, player in pairs(GetPlayersFromCoords(GetEntityCoords(PlayerPedId()), 25.0)) do
                ...
                FrameworkAdmin.Functions.DrawText3D(PlayerCoords.x, PlayerCoords.y, PlayerCoords.z + 1.0, '['..PlayerId..'] '..PlayerName)
            end
        else
            Citizen.Wait(1000)
        end
	...
	while true do
        ...
        if deleteLazer then
            ...
            if hit and (IsEntityAVehicle(entity) or IsEntityAPed(entity) or IsEntityAnObject(entity)) then
                ...
                FrameworkAdmin.Functions.DrawText3D(entityCoord.x, entityCoord.y, entityCoord.z, "Object: " .. entity .. " Model: " .. GetEntityModel(entity).. " \nPress [~g~E~s~] to delete this object.", 2)
