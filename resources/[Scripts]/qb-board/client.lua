...
AddEventHandler('Framework:Client:OnPlayerLoaded', function()
    ...
    Framework.Functions.TriggerCallback('qb-board:server:GetConfig', function(config)
    ...
    while true do
        if IsControlJustPressed(0, Config.OpenKey) then
            if not scoreboardOpen then
                Framework.Functions.TriggerCallback('qb-board:server:GetActiveCops', function(cops)
...
RegisterNetEvent('qb-board:client:SetActivityBusy')
AddEventHandler('qb-board:client:SetActivityBusy', function(activity, busy)
