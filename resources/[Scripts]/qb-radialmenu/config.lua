...
Config.Menu = {
 ...
 [21] = {
    ...
    subMenus = {"ambulance:garage:asprinter", "ambulance:garage:touran", "ambulance:garage:heli", "vehicle:delete"}
 },
 [22] = {
    id = "scrapyard",
...
[32] = {
    ...
    icon = "#citizen-action-vehicle",
    enableMenu = function()
        if not exports['qb-hospital']:GetDeathStatus() and Framework.Functions.GetPlayerData().job.name == 'mechanic' and Framework.Functions.GetPlayerData().job.onduty then
            return true
        end
    end,
    subMenus = {"mechanic:repairfull", "mechanic:repairengine", "mechanic:clean"}
 },
}
...
Config.SubMenus = {
    ...
    ["mechanic:repairengine"] = {
        ...
        close = true,
        functiontype = "client",
        functionName = "mechanic:client:RepairVehicle",
    },
    ["mechanic:clean"] = {
        title = "Clean Body",
        icon = "#citizen-action-vehicle",
...
RegisterNetEvent('qb-radialmenu:client:update:duty:vehicles')
AddEventHandler('qb-radialmenu:client:update:duty:vehicles', function()
    Config.Menu[11].subMenus = exports['qb-police']:GetVehicleList()
end)