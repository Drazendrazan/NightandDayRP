...
Config.ObjectOptions = {
    ...
    [GetHashKey('g_m_m_korboss_01')] = {
        [1] = {
            ...
            ['EventName'] = 'qb-secretjob:inschrijven',
        },
    },
    ...
    [GetHashKey('cs_josef')] = {
        [1] = {
            ...
            ['EventType'] = 'Client',
            ['Logo'] = '<i class="fas fa-tools"></i>',
            ['EventName'] = 'qb-dealers:client:open:dealer',
        },
    },
    ...
    [GetHashKey('s_m_y_ammucity_01')] = {
        [1] = {
            ...
            ['EventType'] = 'Client',
            ['Logo'] = '<i class="fas fa-play-circle"></i>',
            ['EventName'] = 'qb-hunting:client:sync:start',
        },
        [2] = {
            ['Name'] = 'Stop Hunting',
            ['EventType'] = 'Client',
            ['Logo'] = '<i class="fas fa-stop-circle"></i>',
            ['EventName'] = 'qb-hunting:client:sync:stop',
        },
        [3] = {
            ['Name'] = 'Sell meat',
            ['EventType'] = 'Server',
            ['Logo'] = '<i class="fas fa-wallet"></i>',
            ['EventName'] = 'qb-hunt:sell',
        },
    },
}
...
Config.MechanicleMenu = {
    [1] = {
        ['Name'] = 'Repair Full',
        ['EventType'] = 'Client',
        ['Logo'] = '<i class="fas fa-hammer"></i>',
        ['EventName'] = 'mechanic:client:AdvancedRepairVehicle',
    },
    [2] = {
        ['Name'] = 'Repair Engine',
        ['EventType'] = 'Client',
        ['Logo'] = '<i class="fas fa-tools"></i>',
        ['EventName'] = 'mechanic:client:RepairVehicle',
    },
    [2] = {
        ['Name'] = 'Clean Vehicle',
        ['EventType'] = 'Client',
        ['Logo'] = '<i class="fas fa-hand-sparkles"></i>',
        ['EventName'] = 'qb-cardealer:client:sell:closest:vehicle',
    },
}
