		...
		if fromItemData ~= nil and fromItemData.amount >= fromAmount then
			...
			elseif Framework.Shared.SplitStr(toInventory, "-")[1] == "otherplayer" then
				...
				if toItemData ~= nil then
					...
					TriggerEvent("qb-logs:server:SendLog", "robbing", "Dropped item", "red", "**".. GetPlayerName(src) .. "** (CID: *"..Player.PlayerData.citizenid.."* | *"..src.."*) New dropped item; name: **"..itemInfo["name"].."**, amount: **" .. fromAmount .. "** to player: **".. GetPlayerName(OtherPlayer.PlayerData.source) .. "** (CID: *"..OtherPlayer.PlayerData.citizenid.."* | id: *"..OtherPlayer.PlayerData.source.."*)")
				end
				local itemInfo = Framework.Shared.Items[fromItemData.name:lower()]
			...
			elseif Framework.Shared.SplitStr(toInventory, "-")[1] == "trunk" then
				...
				if toItemData ~= nil then
					...
					if toItemData.name ~= fromItemData.name then
						...
						Player.Functions.AddItem(toItemData.name, toAmount, fromSlot, toItemData.info)
						TriggerEvent("qb-logs:server:SendLog", "trunk", "Swapped item", "orange", "**".. GetPlayerName(src) .. "** (CID: *"..Player.PlayerData.citizenid.."* | id: *"..src.."*) Swapped item; name: **"..itemInfo["name"].."**, amount: **" .. toAmount .. "** to: **" .. fromItemData.name .. "**, amount: **" .. fromAmount .. "** - Registration number: *" .. plate .. "*")
					end
				else
					local itemInfo = Framework.Shared.Items[fromItemData.name:lower()]
					TriggerEvent("qb-logs:server:SendLog", "trunk", "dropped Item", "red", "**".. GetPlayerName(src) .. "** (CID: *"..Player.PlayerData.citizenid.."* | id: *"..src.."*) New dropped item; name: **"..itemInfo["name"].."**, amount: **" .. fromAmount .. "** - Registration number: *" .. plate .. "*")
				end
				local itemInfo = Framework.Shared.Items[fromItemData.name:lower()]
			...
			elseif Framework.Shared.SplitStr(toInventory, "-")[1] == "glovebox" then
				...
				if toItemData ~= nil then
					...
					if toItemData.name ~= fromItemData.name then
						...
						Player.Functions.AddItem(toItemData.name, toAmount, fromSlot, toItemData.info)
						TriggerEvent("qb-logs:server:SendLog", "glovebox", "Swapped item", "orange", "**".. GetPlayerName(src) .. "** (CID: *"..Player.PlayerData.citizenid.."* | id: *"..src.."*) Swapped item; name: **"..itemInfo["name"].."**, amount: **" .. toAmount .. "** to: **" .. fromItemData.name .. "**, amount: **" .. fromAmount .. "** - Registration number: *" .. plate .. "*")
					end
				else
					local itemInfo = Framework.Shared.Items[fromItemData.name:lower()]
					TriggerEvent("qb-logs:server:SendLog", "glovebox", "Dropped item", "red", "**".. GetPlayerName(src) .. "** (CID: *"..Player.PlayerData.citizenid.."* | id: *"..src.."*) New dropped item; name: **"..itemInfo["name"].."**, amount: **" .. fromAmount .. "** - Registration number: *" .. plate .. "*")
				end
				local itemInfo = Framework.Shared.Items[fromItemData.name:lower()]
			...
			elseif Framework.Shared.SplitStr(toInventory, "-")[1] == "stash" then
				...
				if toItemData ~= nil then
					...
					if toItemData.name ~= fromItemData.name then
						...
						Player.Functions.AddItem(toItemData.name, toAmount, fromSlot, toItemData.info)
						TriggerEvent("qb-logs:server:SendLog", "stash", "Swapped item", "orange", "**".. GetPlayerName(src) .. "** (CID: *"..Player.PlayerData.citizenid.."* | id: *"..src.."*) Swapped item; name: **"..itemInfo["name"].."**, amount: **" .. toAmount .. "** to: **" .. fromItemData.name .. "**, amount: **" .. fromAmount .. "** - stash: *" .. stashId .. "*")
					end
				else
					local itemInfo = Framework.Shared.Items[fromItemData.name:lower()]
					TriggerEvent("qb-logs:server:SendLog", "stash", "Dropped item", "red", "**".. GetPlayerName(src) .. "** (CID: *"..Player.PlayerData.citizenid.."* | id: *"..src.."*) New dropped item; name: **"..itemInfo["name"].."**, amount: **" .. fromAmount .. "** - stash: *" .. stashId .. "*")
				end
				local itemInfo = Framework.Shared.Items[fromItemData.name:lower()]
				...
				if toInventory == nil or toInventory == 0 then
					...
					if toItemData ~= nil then
						...
						if toItemData.name ~= fromItemData.name then
							...
							TriggerEvent("qb-logs:server:SendLog", "drop", "Swapped item", "orange", "**".. GetPlayerName(src) .. "** (CID: *"..Player.PlayerData.citizenid.."* | id: *"..src.."*) Swapped item; name: **"..itemInfo["name"].."**, amount: **" .. toAmount .. "** to: **" .. fromItemData.name .. "**, amount: **" .. fromAmount .. "** - dropid: *" .. toInventory .. "*")
						end
					else
						local itemInfo = Framework.Shared.Items[fromItemData.name:lower()]
						TriggerEvent("qb-logs:server:SendLog", "drop", "Dropped item", "red", "**".. GetPlayerName(src) .. "** (CID: *"..Player.PlayerData.citizenid.."* | id: *"..src.."*) New dropped item; name: **"..itemInfo["name"].."**, amount: **" .. fromAmount .. "** - dropid: *" .. toInventory .. "*")
					end
					local itemInfo = Framework.Shared.Items[fromItemData.name:lower()]
		...
		if fromItemData ~= nil and fromItemData.amount >= fromAmount then
			...
			if toInventory == "player" or toInventory == "hotbar" then
				...
				if toItemData ~= nil then
					...
					TriggerEvent("qb-logs:server:SendLog", "robbing", "Recieved Item", "green", "**".. GetPlayerName(src) .. "** (CID: *"..Player.PlayerData.citizenid.."* | id: *"..src.."*) took item; name: **"..fromItemData.name.."**, amount: **" .. fromAmount .. "** from player: **".. GetPlayerName(OtherPlayer.PlayerData.source) .. "** (CID: *"..OtherPlayer.PlayerData.citizenid.."* | *"..OtherPlayer.PlayerData.source.."*)")
				end
				Player.Functions.AddItem(fromItemData.name, fromAmount, toSlot, fromItemData.info)
			else
				local toItemData = OtherPlayer.PlayerData.items[toSlot]
			...
			if toInventory == "player" or toInventory == "hotbar" then
				...
				if toItemData ~= nil then
					...
					if toItemData.name ~= fromItemData.name then
						...
						TriggerEvent("qb-logs:server:SendLog", "trunk", "Swapped item", "orange", "**".. GetPlayerName(src) .. "** (CID: *"..Player.PlayerData.citizenid.."* | id: *"..src.."*) Swapped item; name: **"..toItemData.name.."**, amount: **" .. toAmount .. "** with item; name: **"..itemInfo["name"].."**, amount: **" .. toAmount .. "** Registration number: *" .. plate .. "*")
					else
						...
						TriggerEvent("qb-logs:server:SendLog", "trunk", "Stacked item", "orange", "**".. GetPlayerName(src) .. "** (CID: *"..Player.PlayerData.citizenid.."* | id: *"..src.."*) Stacked item; name: **"..toItemData.name.."**, amount: **" .. toAmount .. "** from Registration number: *" .. plate .. "*")
					end
				else
					TriggerEvent("qb-logs:server:SendLog", "trunk", "Recieved Item", "green", "**".. GetPlayerName(src) .. "** (CID: *"..Player.PlayerData.citizenid.."* | id: *"..src.."*) reveived item; name: **"..fromItemData.name.."**, amount: **" .. fromAmount.. "** Registration number: *" .. plate .. "*")
				end
				Player.Functions.AddItem(fromItemData.name, fromAmount, toSlot, fromItemData.info)
			else
				local toItemData = Trunks[plate].items[toSlot]
			...
			if toInventory == "player" or toInventory == "hotbar" then
				...
				if toItemData ~= nil then
					...
					if toItemData.name ~= fromItemData.name then
						...
						TriggerEvent("qb-logs:server:SendLog", "glovebox", "Gewisseld", "orange", "**".. GetPlayerName(src) .. "** (CID: *"..Player.PlayerData.citizenid.."* | id: *"..src..")* Swapped item; name: **"..toItemData.name.."**, amount: **" .. toAmount .. "** with item; name: **"..itemInfo["name"].."**, amount: **" .. toAmount .. "** Registration number: *" .. plate .. "*")
					else
						TriggerEvent("qb-logs:server:SendLog", "glovebox", "Stacked item", "orange", "**".. GetPlayerName(src) .. "** (CID: *"..Player.PlayerData.citizenid.."* | id: *"..src.."*) Stacked item: name: **"..toItemData.name.."**, amount: **" .. toAmount .. "** from Registration number: *" .. plate .. "*")
					end
				else
					TriggerEvent("qb-logs:server:SendLog", "glovebox", "Recieved Item", "green", "**".. GetPlayerName(src) .. "** (CID: *"..Player.PlayerData.citizenid.."* | id: *"..src.."*) reveived item; name: **"..fromItemData.name.."**, amount: **" .. fromAmount.. "** Registration number: *" .. plate .. "*")
				end
				Player.Functions.AddItem(fromItemData.name, fromAmount, toSlot, fromItemData.info)
			else
				local toItemData = Gloveboxes[plate].items[toSlot]
			...
			if toInventory == "player" or toInventory == "hotbar" then
				...
				if toItemData ~= nil then
					...
					if toItemData.name ~= fromItemData.name then
						...
						TriggerEvent("qb-logs:server:SendLog", "stash", "Swapped item", "orange", "**".. GetPlayerName(src) .. "** (CID: *"..Player.PlayerData.citizenid.."* | id: *"..src.."*) Swapped item; name: **"..toItemData.name.."**, amount: **" .. toAmount .. "** with item; name: **"..fromItemData.name.."**, amount: **" .. fromAmount .. "** stash: *" .. stashId .. "*")
					else
						TriggerEvent("qb-logs:server:SendLog", "stash", "Stacked item", "orange", "**".. GetPlayerName(src) .. "** (CID: *"..Player.PlayerData.citizenid.."* | id: *"..src.."*) Stacked item; name: **"..toItemData.name.."**, amount: **" .. toAmount .. "** from stash: *" .. stashId .. "*")
					end
				else
					TriggerEvent("qb-logs:server:SendLog", "stash", "Recieved Item", "green", "**".. GetPlayerName(src) .. "** (CID: *"..Player.PlayerData.citizenid.."* | id: *"..src.."*) reveived item; name: **"..fromItemData.name.."**, amount: **" .. fromAmount.. "** stash: *" .. stashId .. "*")
				end
				Player.Functions.AddItem(fromItemData.name, fromAmount, toSlot, fromItemData.info)
			else
				local toItemData = Stashes[stashId].items[toSlot]
				...
				if toItemData ~= nil then
					...
					if toItemData.name ~= fromItemData.name then
						if toSlot ~= 2 then
							...
							TriggerEvent("qb-logs:server:SendLog", "stash", "Swapped item", "orange", "**".. GetPlayerName(src) .. "** (CID: *"..Player.PlayerData.citizenid.."* | id: *"..src.."*) Swapped item; name: **"..toItemData.name.."**, amount: **" .. toAmount .. "** with item; name: **"..fromItemData.name.."**, amount: **" .. fromAmount .. "** stash: *" .. LabId .. "*")
						else
							TriggerClientEvent("qb-inventory:client:UpdatePlayerInventory", src, true)
						end
					else
						TriggerEvent("qb-logs:server:SendLog", "stash", "Stacked item", "orange", "**".. GetPlayerName(src) .. "** (CID: *"..Player.PlayerData.citizenid.."* | id: *"..src.."*) Stacked item; name: **"..toItemData.name.."**, amount: **" .. toAmount .. "** from stash: *" .. LabId .. "*")
					end
				else
					TriggerEvent("qb-logs:server:SendLog", "stash", "Recieved Item", "green", "**".. GetPlayerName(src) .. "** (CID: *"..Player.PlayerData.citizenid.."* | id: *"..src.."*) reveived item; name: **"..fromItemData.name.."**, amount: **" .. fromAmount.. "** stash: *" .. LabId .. "*")
				end
				Player.Functions.AddItem(fromItemData.name, fromAmount, toSlot, fromItemData.info)
			else
				local toItemData = exports['qb-labs']:GetInventoryData(LabId, toSlot)
	...
	elseif Framework.Shared.SplitStr(fromInventory, "-")[1] == "itemshop" then
		...
		if Framework.Shared.SplitStr(shopType, "_")[1] == "Dealer" then
			if Framework.Shared.SplitStr(itemData.name, "_")[1] == "weapon" then
				...
				if Player.Functions.RemoveMoney("cash", price, "dealer-item-bought") then
					...
					TriggerEvent("qb-logs:server:SendLog", "dealers", "Dealer item purchased", "green", "**"..GetPlayerName(src) .. "** Bought a " .. itemInfo["label"] .. " purchased for $"..price)
				else
					TriggerClientEvent("qb-inventory:client:UpdatePlayerInventory", src, true)
		...
		elseif Framework.Shared.SplitStr(shopType, "_")[1] == "Itemshop" then
			if Player.Functions.RemoveMoney("cash", price, "itemshop-bought-item") then
				...
				TriggerClientEvent('Framework:Notify', src, itemInfo["label"] .. " purchased!", "success")
				TriggerEvent("qb-logs:server:SendLog", "shops", "Shop item purchased", "green", "**"..GetPlayerName(src) .. "** Bought a " .. itemInfo["label"] .. " purchased for $"..price)
			else
				TriggerClientEvent("qb-inventory:client:UpdatePlayerInventory", src, true)
				TriggerClientEvent('Framework:Notify', src, "You do not have enough cash", "error")
			end
		...
		elseif Framework.Shared.SplitStr(shopType, "_")[1] == "StreetDealer" then
			if Player.Functions.RemoveItem('money-roll', price) then
				...
				TriggerClientEvent("qb-inventory:client:UpdatePlayerInventory", src, true)
				TriggerClientEvent('Framework:Notify', src, "You do not have enough money rolls", "error")
			end
		else
			...
			if toInventory == "player" or toInventory == "hotbar" then
				...
				if toItemData ~= nil then
					...
					if toItemData.name ~= fromItemData.name then
						...
						TriggerEvent("qb-logs:server:SendLog", "drop", "Swapped item", "orange", "**".. GetPlayerName(src) .. "** (CID: *"..Player.PlayerData.citizenid.."* | id: *"..src.."*) Swapped item; name: **"..toItemData.name.."**, amount: **" .. toAmount .. "** with item; name: **"..fromItemData.name.."**, amount: **" .. fromAmount .. "** - dropid: *" .. fromInventory .. "*")
					else
						TriggerEvent("qb-logs:server:SendLog", "drop", "Stacked item", "orange", "**".. GetPlayerName(src) .. "** (CID: *"..Player.PlayerData.citizenid.."* | id: *"..src.."*) Stacked item; name: **"..toItemData.name.."**, amount: **" .. toAmount .. "** - from dropid: *" .. fromInventory .. "*")
					end
				else
					TriggerEvent("qb-logs:server:SendLog", "drop", "Recieved Item", "green", "**".. GetPlayerName(src) .. "** (CID: *"..Player.PlayerData.citizenid.."* | id: *"..src.."*) reveived item; name: **"..fromItemData.name.."**, amount: **" .. fromAmount.. "** -  dropid: *" .. fromInventory .. "*")
				end
				Player.Functions.AddItem(fromItemData.name, fromAmount, toSlot, fromItemData.info)
			else
				toInventory = tonumber(toInventory)
...
function CreateNewDrop(source, fromSlot, toSlot, itemAmount)
	...
	if Player.Functions.RemoveItem(itemData.name, itemAmount, itemData.slot) then
		...
		TriggerEvent("qb-logs:server:SendLog", "drop", "New Item Drop", "red", "**".. GetPlayerName(source) .. "** (CID: *"..Player.PlayerData.citizenid.."* | id: *"..source.."*) New dropped item; name: **"..itemData.name.."**, amount: **" .. itemAmount .. "**")
...
Framework.Commands.Add("resetinv", "Reset inventory (in case for -None)", {{name="type", help="stash/trunk/glovebox"},{name="id/plate", help="ID of stash or licenseplate"}}, true, function(source, args)
...
Framework.Commands.Add("giveitem", "Give item to player.", {{name="id", help="CID"},{name="item", help="name of item (not label)"}, {name="Amount", help="Amount"}}, true, function(source, args)
