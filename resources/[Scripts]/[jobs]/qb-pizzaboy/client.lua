...
function DrawTarget()
    ...
    if DeliveriesCount == 4 then
        TriggerEvent('qb-phone:client:completedjob', source)
        RemoveCancelBlip()
      ...
      if pizza == 1 then
        TriggerEvent('qb-phone:client:oneleft', source)
      else
        if pizza == 4 then
          pizza = 'Four'
        elseif pizza == 3 then
        ...
        --TriggerEvent('qb-phone:client:delivery', source)
      end
        if LastGoal == RandomPoint then
            DrawTarget()
        else
            if RandomPoint == 2 then
								xxx =-273.58
								yyy =28.33
								zzz =54.75
                LastGoal = 2
            ...
            TriggerEvent('qb-phone:client:deliverto', source)
        end
    end
end
            ...
            if Delivered then
                ...
                if DistanceFromCancelZone <= 2.5 then
                    ...
                    if DistanceFromCancelZone <= 7 then
                        if IsControlJustReleased(0, 46) then
                            TriggerEvent('qb-phone:client:canceledjob', source)
							EndOfWork()
                        end
                    end
                end
...
function EndOfWork()
    ...
    if IsPedInAnyVehicle(ped, false) then
        ...
        if IsVehicleModel(Van, GetHashKey('panto')) then
            ...
            TriggerEvent('qb-phone:client:vehicleinfo', source)
        end
    else
        InService = false
        BlipSell = nil
