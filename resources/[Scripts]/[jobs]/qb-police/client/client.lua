...
RegisterNetEvent('qb-police:client:SpawnSpikeStrip')
AddEventHandler('qb-police:client:SpawnSpikeStrip', function()
    if #SpawnedSpikes + 1 < SpikeConfig.MaxSpikes then
        if PlayerJob.name == "police" and PlayerJob.onduty then
            ...
            spikesSpawned = true
            TriggerServerEvent('qb-police:server:SyncSpikes', SpawnedSpikes)
...
RegisterNetEvent('qb-police:client:SyncSpikes')
AddEventHandler('qb-police:client:SyncSpikes', function(table)
    SpawnedSpikes = table
end)
