        ...
        if VehicleStatus[plate] ~= nil then 
            ...
            if VehicleStatus[plate]["fuel"] <= 80 and (chance >= 81 and chance <= 100) then
                ...
                if VehicleStatus[plate]["fuel"] <= 80 and VehicleStatus[plate]["fuel"] >= 60 then
                    ...
                    exports['qb-fuel']:SetFuelLevel(vehicle, GetVehicleNumberPlateText(vehicle), fuel - 2.0, false)
                elseif VehicleStatus[plate]["fuel"] <= 59 and VehicleStatus[plate]["fuel"] >= 40 then
                    exports['qb-fuel']:SetFuelLevel(vehicle, GetVehicleNumberPlateText(vehicle), fuel - 4.0, false)
                elseif VehicleStatus[plate]["fuel"] <= 39 and VehicleStatus[plate]["fuel"] >= 20 then
                    exports['qb-fuel']:SetFuelLevel(vehicle, GetVehicleNumberPlateText(vehicle), fuel - 6.0, false)
                elseif VehicleStatus[plate]["fuel"] <= 19 and VehicleStatus[plate]["fuel"] >= 6 then
                    exports['qb-fuel']:SetFuelLevel(vehicle, GetVehicleNumberPlateText(vehicle), fuel - 8.0, false)
                else
                    exports['qb-fuel']:SetFuelLevel(vehicle, GetVehicleNumberPlateText(vehicle), fuel - 10.0, false)
                end
            end
        end
    end
