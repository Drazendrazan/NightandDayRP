...
Framework.Functions.CreateUseableItem("glasswhiskey", function(source, item)
	local Player = Framework.Functions.GetPlayer(source)
	if Player.Functions.GetItemBySlot(item.slot) ~= nil then
        TriggerClientEvent('qb-items:client:drink:alcohol', source, 'glasswhiskey', 'glasswhiskey')
    end
end)
...
Framework.Functions.CreateUseableItem("beer", function(source, item)
	local Player = Framework.Functions.GetPlayer(source)
	if Player.Functions.GetItemBySlot(item.slot) ~= nil then
        TriggerClientEvent('qb-items:client:drink:alcohol', source, 'beer', 'beer')
    end
end)
...
Framework.Functions.CreateUseableItem("vodka", function(source, item)
	local Player = Framework.Functions.GetPlayer(source)
	if Player.Functions.GetItemBySlot(item.slot) ~= nil then
        TriggerClientEvent('qb-items:client:drink:alcohol', source, 'vodka', 'vodka')
    end
end)
...
Framework.Functions.CreateUseableItem("glasswine", function(source, item)
	local Player = Framework.Functions.GetPlayer(source)
	if Player.Functions.GetItemBySlot(item.slot) ~= nil then
        TriggerClientEvent('qb-items:client:drink:alcohol', source, 'glasswine', 'glasswine')
    end
end)
...
Framework.Functions.CreateUseableItem("glassbeer", function(source, item)
	local Player = Framework.Functions.GetPlayer(source)
	if Player.Functions.GetItemBySlot(item.slot) ~= nil then
        TriggerClientEvent('qb-items:client:drink:alcohol', source, 'glassbeer', 'glassbeer')
    end
end)
...
Framework.Functions.CreateUseableItem("bloodymary", function(source, item)
	local Player = Framework.Functions.GetPlayer(source)
	if Player.Functions.GetItemBySlot(item.slot) ~= nil then
        TriggerClientEvent('qb-items:client:drink:alcohol', source, 'bloodymary', 'bloodymary')
    end
end)
...
Framework.Functions.CreateUseableItem("champagne", function(source, item)
	local Player = Framework.Functions.GetPlayer(source)
	if Player.Functions.GetItemBySlot(item.slot) ~= nil then
        TriggerClientEvent('qb-items:client:drink:alcohol', source, 'champagne', 'champagne')
    end
end)
...
Framework.Functions.CreateUseableItem("glasschampagne", function(source, item)
	local Player = Framework.Functions.GetPlayer(source)
	if Player.Functions.GetItemBySlot(item.slot) ~= nil then
        TriggerClientEvent('qb-items:client:drink:alcohol', source, 'glasschampagne', 'glasschampagne')
    end
end)
...
Framework.Functions.CreateUseableItem("dusche", function(source, item)
	local Player = Framework.Functions.GetPlayer(source)
	if Player.Functions.GetItemBySlot(item.slot) ~= nil then
        TriggerClientEvent('qb-items:client:drink:alcohol', source, 'dusche', 'dusche')
    end
end)
...
Framework.Functions.CreateUseableItem("tequila", function(source, item)
	local Player = Framework.Functions.GetPlayer(source)
	if Player.Functions.GetItemBySlot(item.slot) ~= nil then
        TriggerClientEvent('qb-items:client:drink:alcohol', source, 'tequila', 'tequila')
    end
end)
...
Framework.Functions.CreateUseableItem("tequilashot", function(source, item)
	local Player = Framework.Functions.GetPlayer(source)
	if Player.Functions.GetItemBySlot(item.slot) ~= nil then
        TriggerClientEvent('qb-items:client:drink:alcohol', source, 'tequilashot', 'tequilashot')
    end
end)
...
Framework.Functions.CreateUseableItem("whitewine", function(source, item)
	local Player = Framework.Functions.GetPlayer(source)
	if Player.Functions.GetItemBySlot(item.slot) ~= nil then
        TriggerClientEvent('qb-items:client:drink:alcohol', source, 'whitewine', 'whitewine')
    end
end)
...
Framework.Functions.CreateUseableItem("pinacolada", function(source, item)
	local Player = Framework.Functions.GetPlayer(source)
	if Player.Functions.GetItemBySlot(item.slot) ~= nil then
        TriggerClientEvent('qb-items:client:drink:alcohol', source, 'pinacolada', 'pinacolada')
    end
end)
...
Framework.Functions.CreateUseableItem("bag", function(source, item)
    local Player = Framework.Functions.GetPlayer(source)
    TriggerClientEvent("qb-inventory:bag:UseBag", source)
    TriggerEvent("qb-log:server:CreateLog", "inventory", "Bags", "white", "Player opened a bag **"..GetPlayerName(source).."** Citizen ID: **"..Player.PlayerData.citizenid.. "**", false)
end)
...
Framework.Functions.CreateUseableItem("oxy", function(source, item)
	local Player = Framework.Functions.GetPlayer(source)
	if Player.Functions.GetItemBySlot(item.slot) ~= nil then
        TriggerClientEvent('qb-items:client:use:oxy', source)
    end
end)
...
Framework.Functions.CreateUseableItem("jerry_can", function(source, item)
    local Player = Framework.Functions.GetPlayer(source)
    if Player.Functions.GetItemBySlot(item.slot) ~= nil then
        TriggerClientEvent('qb-fuel:server:update:fuel', source, 'jerry_can')
    end
end)
...
Framework.Functions.CreateUseableItem("meth-bag", function(source, item)
    local Player = Framework.Functions.GetPlayer(source)
    TriggerClientEvent("qb-items:client:use:meth", source)
end)
...
Framework.Functions.CreateUseableItem("ciggy", function(source, item)
	local Player = Framework.Functions.GetPlayer(source)
	if Player.Functions.GetItemBySlot(item.slot) ~= nil then
        TriggerClientEvent('qb-items:client:use:cigarette', source, true)
    end
end)
...
Framework.Functions.CreateCallback('qb-items:server:giveitem', function(ItemName, Amount)
