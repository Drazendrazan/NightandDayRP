...
RegisterServerEvent('qb-humanlabs:server:Openkluisjes')
AddEventHandler('qb-humanlabs:server:Openkluisjes', function(bool)

    Config.Lab["isOpened"] = bool

    TriggerClientEvent('qb-humanlabs:client:setLabState', -1, bool)
end)
