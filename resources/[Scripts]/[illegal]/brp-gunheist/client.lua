...
AddEventHandler('do', function(dropId)
	...
	Framework.Functions.Progressbar("drilling_", "Drilling...", math.random(20000, 30000), false, true, {}, {}, {}, {}, function()
...
AddEventHandler('lrp-gunheist:useDecryptionKey', function(item)
	...
	if dstcheck < 5 then
		...
		Framework.Functions.Progressbar("drilling_", "Decrypting with key...", math.random(10000, 15000), false, true, {}, {}, {}, {}, function()
			ClearPedTasks(PlayerPedId())
