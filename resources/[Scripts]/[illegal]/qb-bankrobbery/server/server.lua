...
Framework.Functions.CreateCallback("qb-atmrobbery:getHackerDevice",function(source,cb)
...
RegisterServerEvent('qb-atm:rem:drill')
AddEventHandler('qb-atm:rem:drill', function()
local xPlayer = Framework.Functions.GetPlayer(source)
	xPlayer.Functions.RemoveItem('drill', 1)
end)

Framework.Functions.CreateUseableItem('electronickit', function(source)
	TriggerClientEvent('qb-atm:item', source)
end)
...
RegisterServerEvent('qb-atm:CooldownServer')
AddEventHandler('qb-atm:CooldownServer', function(bool)
    atmcooldown = bool
	if bool then 
		cooldown()
	end	 
...
RegisterServerEvent('qb-atm:CooldownNotify')
AddEventHandler('qb-atm:CooldownNotify', function()
...
Framework.Functions.CreateCallback("qb-atm:GetCooldown",function(source,cb)
	cb(atmcooldown)
end)
