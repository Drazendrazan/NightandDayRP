...
AddEventHandler('oxydelivery:receiveBigRewarditem', function()
	...
	TriggerClientEvent('qb-inventory:client:ItemBox', src, Framework.Shared.Items["green-card"], 'add')
end)
...
AddEventHandler('oxydelivery:receiveoxy', function()
	...
	TriggerClientEvent('qb-inventory:client:ItemBox', src, Framework.Shared.Items["oxy"], 'add')
