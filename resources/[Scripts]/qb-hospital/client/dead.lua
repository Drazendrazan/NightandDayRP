...
AddEventHandler('Framework:Client:OnJobUpdate', function(JobInfo)
    PlayerJob = JobInfo
    TriggerServerEvent("qb-hospital:server:SetDoctor")
end)

RegisterNetEvent('qb-hospital:client:resetCallForBackup')
AddEventHandler('qb-hospital:client:resetCallForBackup',function()
    hasCalledForBackup = false
end)
