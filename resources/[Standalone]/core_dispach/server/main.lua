...
Framework.Functions.CreateCallback("core_dispach:getPersonalInfo", function(source, cb)
...
Framework.Functions.CreateCallback("core_dispach:getInfo", function(source, cb)
        local generated = {}
...
Framework.Functions.CreateCallback("core_dispach:getUnits", function(source, cb)
        local generated = {}
