...
AddEventHandler('playerDropped', function(reason) 
	...
	TriggerEvent("qb-logs:server:SendLog", "joinleave", "Dropped", "red", "**".. GetPlayerName(src) .. "** ("..GetPlayerIdentifiers(src)[1]..") left the server.")
...
AddEventHandler('playerConnecting', function(playerName, setKickReason, deferrals)
	...
	if name == nil then 
		Framework.Functions.Kick(src, 'Restart steam please.', setKickReason, deferrals)
        CancelEvent()
        return false
	end
...
AddEventHandler("DevMode", function()
    ...
    TriggerEvent("qb-log:server:CreateLog", "anticheat", "Opening devtools", "orange", "**".. GetPlayerName(src) .. " tried to open devtools")
...
AddEventHandler('Framework:ToggleDuty', function(Value)
	...
	if Value then
		...
		TriggerClientEvent('qb-phone:client:induty', source)
		...
		TriggerClientEvent('qb-phone:client:offduty', source)
