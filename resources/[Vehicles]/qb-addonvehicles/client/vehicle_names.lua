Citizen.CreateThread(function()
    ...
    AddTextEntry('arv10_bonnet', "Botnet")
    AddTextEntry('arv10_exhaust', "Exhaust")
    AddTextEntry('arv10_front_skirt', "Skirt")
    AddTextEntry('arv10_rear_skirt', "Skirt")
    AddTextEntry('arv10_skirts', "Skirt")
    AddTextEntry('arv10_spolier', "Spoiler")
    AddTextEntry('nf_bonnet', "Botnet")
    AddTextEntry('nf_front_skirt', "Skirt")
    AddTextEntry('bumpf_1', "Voor Bumper #1")
    AddTextEntry('bumpf_2', "Voor Bumper #2")
    AddTextEntry('bumpr_1', "Achter Bumper #1")
    AddTextEntry('pots_1', "IDK??")
    AddTextEntry('rollcage', "Rollcage")
    AddTextEntry('spoil_1', "Spoiler #1")
    AddTextEntry('spoil_2', "Spoiler #2")
    AddTextEntry('spoil_3', "Spoiler #3")
    AddTextEntry('x5e53_bnt1', "Geen idee?")
    AddTextEntry('x5e53_bumr1', "Achter Bumper #1")
    AddTextEntry('x5e53_ext1', "Exhaust")
    AddTextEntry('x5e53_skirt1', "Skirt #1")
    AddTextEntry('x5e53_split1', "Split #3")
end)